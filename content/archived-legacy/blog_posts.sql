...
Thanks to everyone who was involved in our first year. If you missed it last year, now is the perfect time to start planning for this year or even to volunteer to help out this summer or join us on a training run or two. Working together, we can have a huge impact… one step at a time.', 'https://miro.medium.com/v2/resize:fit:1200/1*E9OKUmFYEyqjklaXMjEOXg.jpeg', 'Ben West', '2016-03-20 00:00:00+00', '{"climate","environment","community","activism","running"}', 'true', '2025-06-05 02:30:10.964504+00', '2025-06-05 02:30:10.964504+00', 'admin', 'admin'), ('8d1d15b9-51d6-4bf4-a3c5-eb4b3ca983a7', 'Still Crowned', 'still-crowned', 'A country that talks like a democracy but still curtsies like a colony', '<div class="prose prose-lg prose-invert max-w-none">
...
I'm confident that Canadians are savvy enough to see through the industry spin. We want to be part of the solution, not part of the problem. That's bad news for Big Oil and good news for everyone else.', 'https://i0.wp.com/www.benwest.blog/wp-content/uploads/2019/05/FEA_Trains6_2431.jpg?w=1000&ssl=1', 'Ben West', '2014-07-23 00:00:00+00', '{"environment","energy","pipelines","transportation","policy"}', 'true', '2025-06-05 02:32:46.248973+00', '2025-06-05 02:32:46.248973+00', 'admin', 'admin'), ('b61144a6-3b33-46c4-8e74-3bd8dbdd3505', 'Standing With Chief Rueben George: Indigenous Leadership Against Tar Sands', 'standing-with-chief-rueben-george-indigenous-leadership-against-tar-sands', 'Earlier this summer it filled my heart with pride and joy to watch my good friend Chief Rueben George, stand before the sacred tree in the Arbor of a Sun Dance ceremony in Lakota territory, South Dakota and read a declaration of indigenous spiritual leaders against tar sands pipelines and tankers.', 'Originally published 01/28/2013 at www.huffingtonpost.ca.
...
I sincerely hope that these challenges that we collectively face can provide an opportunity for cultural exchange, healing, empowerment and a clear pathway to move forward together.', 'https://www.benwest.blog/wp-content/uploads/2019/05/Rueben-George-1024x1024.png', 'Ben West', '2013-01-28 00:00:00+00', '{"indigenous","activism","pipelines","ceremony","solidarity","environment"}', 'true', '2025-06-05 02:35:12.91442+00', '2025-06-05 02:35:12.91442+00', 'admin', 'admin'), ('fc602a76-2cf4-4dad-aa07-adb06bc4d5cf', 'Is Not Having Kids an Effective Climate Solution?', 'is-not-having-kids-an-effective-climate-solution', 'Climate change isn't about individual choices—it's about confronting corporate power, public manipulation, and systemic design."', '---
